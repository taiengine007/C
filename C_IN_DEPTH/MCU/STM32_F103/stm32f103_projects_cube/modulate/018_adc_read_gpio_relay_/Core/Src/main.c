...
#define SHUNT_RESISTOR 100.0f     // Shunt resistor value in ohms
#define ADC_RESOLUTION 4096.0f   // 12-bit ADC
#define VREF 5.0f                // ADC reference voltage in volts
#define TEMP_MIN 23.0f            // Minimum temperature (°C)
#define TEMP_MAX 200.0f          // Maximum temperature (°C)
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(relay_pc10_GPIO_Port, relay_pc10_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : relay_pc10_Pin */
  GPIO_InitStruct.Pin = relay_pc10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(relay_pc10_GPIO_Port, &GPIO_InitStruct);
