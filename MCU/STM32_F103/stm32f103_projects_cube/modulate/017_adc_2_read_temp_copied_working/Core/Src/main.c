...
#define TEMP_MIN 0.0f           // Minimum temperature (e.g., 0°C)
#define TEMP_MAX 100.0f         // Maximum temperature (e.g., 100°C)
#define CURRENT_MIN 4.0f        // Minimum current (4mA)
#define CURRENT_MAX 20.0f       // Maximum current (20mA)
#define VOLTAGE_MIN 1.0f        // Voltage corresponding to 4mA
#define VOLTAGE_MAX 5.0f        // Voltage corresponding to 20mA
/* USER CODE BEGIN PFP */
